...
print(f"We need to put about {average_passengers_per_car}'"
      "in each car.")

# ============================================Exercise 2=========================================

age = input("How old are you? ")  # program will be waiting user's string value.
print("You are {} years old".format(age))  # program will return formatted string with the user's value.
