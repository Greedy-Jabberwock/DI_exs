...
-- Get a list of all the movies that have a rating of G or PG-13.Filter this list further: 
-- look for only movies that are under 2 hours long, 
...
-- Find a customer in the customer table, and change his/her details to your details, 
-- using SQL UPDATE.
SELECT * 
FROM customer 
WHERE customer_id = 3;
